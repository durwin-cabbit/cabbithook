...
function watermark(L165, L166)
    ...
    local L167 = ""
    local L168 = "cabbithook [" .. L22.upper(L75["build"]) .. "]" .. " | " .. L22.upper(L75["user"]) .. " | " .. L23.floor(L28.latency() * 1000) .. "MS"
    if L166 == "small" then
        L167 = "-"
        L168 = "cabbithook   [" .. L22.upper(L75["build"]) .. "]" .. "   |   " .. L22.upper(L75["user"]) .. "   |   " .. L23.floor(L28.latency() * 1000) .. "MS"
...
local L213 = function(L206, L207, L208)
    ...
    if L70.tickbase_diff ~= nil and L70.tickbase_diff <= -1 and L70.tickbase_diff >= -14 then
        ...
        L25.text(L207, L208 / 3, 200, 200, 255, 255, "c", 0, "✨ defensive ✨")
        L25.rectangle(L207 + 1 - defensive_size_x / 2, L208 / 3 + 10, L110(L70.smooth_defensive_bar / 12 * defensive_size_x, 0, defensive_size_x) - 2, 2, 200, 200, 255, 255)
    else
...
local L401 = function(L359, L360, L361, L362, L363)
    ...
    if L24.get(L360) == "minimal (og)" then
        ...
        elseif L24.get(L360) == "recode alpha" then
            local L389 = ("✨cabbithook✨"):format(L22.format("%02X%02X%02X%02X", L365, L366, L367, L23.max(L368, 100)))
            local L390 = "DT"
            local L391 = "ON SHOT"
...
local L512 = function(L507)
    ...
    if L132(L24.get(L90["misc"][2]), "fire") then
        ...
        g_notify:add(L22.format("fired at %s's %s for %i damage (%d%%) bt=%i (%ims) body=%i?", L27.get_player_name(L507.target), L508, L507.damage, L507.hit_chance, L510, L15(L510 * 1000), L511), { 210, 210, 255, 255 }, 5, nil, "fire")
    end;
...
local function L521(L522)
    ...
    g_notify:add(L22.format("fired at %s's %s for %i damage (%d%%) bt=? (?ms) body=?? s=dormant", L27.get_player_name(L522.userid), L22.lower(L522.aim_hitbox), L522.dmg_health, L522.accuracy * 100), { 210, 210, 255, 255 }, 5, nil, "fire")
end;
local function L523(L524)
    if not L132(L24.get(L90["misc"][2]), "miss") then
        return
    end;
    g_notify:add(L22.format("fired at %s's %s for ? damage (%d%%) bt=? (?ms) body=?? s=dormant", L27.get_player_name(L524.userid), L22.lower(L524.aim_hitbox), L524.accuracy * 100), { 210, 210, 255, 255 }, 5)
...
writefile(L13("!default_preset2124089493w.cfg"), "")
...
local L765 = function()
    ...
    if L132(L24.get(L90["misc"][2]), "config changes") then
        g_notify:add("imported cabbithook anti-aim", nil, 5)
    end
end;
local L773 = function()
    local L766 = ""
